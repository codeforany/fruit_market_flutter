...
import 'package:fruitmarket/screen/admin/my_account/admin_main_category_list_screen.dart';
import 'package:fruitmarket/screen/admin/my_account/delivery_boy_user/delivery_boy_list_screen.dart';
import 'package:fruitmarket/screen/admin/my_account/unit/admin_unit_list_screen.dart';
import 'package:fruitmarket/screen/admin/offer/offer_add_screen.dart';
import 'package:fruitmarket/screen/admin/offer/offer_list_screen.dart';
import 'package:fruitmarket/screen/login/login_screen.dart';
import 'package:fruitmarket/screen/my_account/setting_row.dart';

class AdminMyAccountTabScreen extends StatefulWidget {
  const AdminMyAccountTabScreen({super.key});

  @override
  State<AdminMyAccountTabScreen> createState() => _AdminMyAccountTabScreenState();
}

class _AdminMyAccountTabScreenState extends State<AdminMyAccountTabScreen> {
  List menuArr = [
    {'name': 'My Orders', 'ico': 'assets/img/my_order.png', 'order': '1'},
    {'name': 'Main Category', 'ico': 'assets/img/my_order.png', 'order': '2'},
    {'name': 'Units', 'ico': 'assets/img/my_order.png', 'order': '4'},
    {'name': 'Offer', 'ico': 'assets/img/my_order.png', 'order': '5'},
    {'name': 'Delivery Boys', 'ico': 'assets/img/my_order.png', 'order': '6'},
                    ...
                    onPressed: () {
                      switch (obj["order"].toString()) {
                        case "1":
                          ...
                          break;
                        case "2":
                        context.push(AdminMainCategoryListScreen());
                          break;
                        case "3":
                          
                          break;
                        case "4":
                        context.push(AdminUnitListScreen());
                          break;

                        case "5":
                          context.push(OfferListScreen());
                          break;
                        case "6":
                          context.push(DeliveryBoyListScreen());
                          break;
