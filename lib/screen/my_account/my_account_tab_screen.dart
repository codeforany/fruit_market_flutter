...
class MyAccountTabScreen extends StatefulWidget {
  const MyAccountTabScreen({super.key});

  @override
  State<MyAccountTabScreen> createState() => _MyAccountTabScreenState();
}

class _MyAccountTabScreenState extends State<MyAccountTabScreen> {
  List menuArr = [
